...
public class SETImpl<Key extends Comparable<Key>> implements SET<Key> {
    ...
    public void add(Key key) {
        requiresNotNull(key, "called add() with a null key");
        set.add(key);
    }
    ...
    public boolean contains(Key key) {
        requiresNotNull(key, "called contains() with a null key");
    ...
    public void delete(Key key) {
        requiresNotNull(key,"called delete() with a null key");
        set.remove(key);
    }
    ...
    public void remove(Key key) {
        requiresNotNull(key,"called remove() with a null key");
        set.remove(key);
    }
