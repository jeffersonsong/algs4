 ...
 */
public class IndexMinPQImpl<Key extends Comparable<Key>> extends MinPQInvariant implements IndexMinPQ<Key>  {
     ...
     */
    public IndexMinPQImpl(int maxN) {
    ...
    ***************************************************************************/
    ...
    private class HeapIterator implements Iterator<Integer> {
        ...
        public HeapIterator() {
            copy = new IndexMinPQImpl<>(pq.length - 1);
            for (int i = 1; i <= n; i++)
    ...
    public static void main(String[] args) {
        ...
        IndexMinPQ<String> pq = new IndexMinPQImpl<>(strings.length);
