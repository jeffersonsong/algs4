 ...
 *  text stream.
 *  This implementation uses a {@link IndexPQBinaryHeapImpl} to perform the multiway
 *  merge. 
 *  <p>
...
public class Multiway { 
    ...
    private static void merge(In[] streams) {
        ...
        IndexPQ<String> pq = IndexPQBinaryHeapImpl.indexMinPQ(n);
        for (int i = 0; i < n; i++)
