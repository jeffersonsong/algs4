...
public class EulerianTest {
    ...
    public void testEulerianPath() {
        ...
        g1.addEdge(1, new Edge(1,0));
        g1.addEdge(0, new Edge(0, 2));
        g1.addEdge(2, new Edge(2, 1));
        g1.addEdge(0, new Edge(0, 3));
        g1.addEdge(3, new Edge(3,4));
    ...
    public void testEulerianCycle() {
        ...
        g2.addEdge(1, new Edge(1, 0));
        g2.addEdge(0, new Edge(0, 2));
        g2.addEdge(2, new Edge(2, 1));
        g2.addEdge(0, new Edge(0,3));
        g2.addEdge(3, new Edge(3,4));
        g2.addEdge(4, new Edge(4,0));
    ...
    public void testEulerianCycle2() {
        ...
        g4.addEdge(0, new Edge(0,1));
        g4.addEdge(1, new Edge(1,2));
        g4.addEdge(2, new Edge(2,0));
    ...
    public void testNonEulerian() {
        ...
        g3.addEdge(1, new Edge(1, 0));
        g3.addEdge(0, new Edge(0,2));
        g3.addEdge(2, new Edge(2,1));
        g3.addEdge(0, new Edge(0, 3));
        g3.addEdge(3, new Edge(3,4));
        g3.addEdge(1, new Edge(1,3));
